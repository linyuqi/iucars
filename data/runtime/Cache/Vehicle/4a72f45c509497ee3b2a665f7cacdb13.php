...
<body class="J_scroll_fixed">
	<div class="wrap J_check_wrap">
		<ul class="nav nav-tabs">
	        ...
	        <li class="active"><a href="#">编辑震后感</a></li>
	    </ul>
		          		...
		          		<table cellpadding="2" cellspacing="2" width="100%">
							<tbody>
								<tr>
									...
									<td><input type="hidden" class="input" name="info_id" id="info_id" value="<?php echo ($list["info_id"]); ?>"><?php echo ($list["info_id"]); ?></td>
								</tr>
								<tr width="140">
									<td>评论者:</td>
									<td><input type="text" class="input" name="author" id="author" value="<?php echo ($list["author"]); ?>"><span class="must_red">*</span></td>
								</tr>

						        <tr>
						          <td>评论者头像:</td>
						          <td>
						          	<div><input type='hidden' name='avatar' id='class' value='<?php echo ($list["avatar"]); ?>'>
									...
									<img src='<?php echo ($list["avatar"]); ?>' id='class_preview' width='135' height='113' style='cursor:hand' /></a>
								...
								<tr>
									<td>评论内容:</td>
									<td><textarea name="content" id="content" rows="5" cols="57"><?php echo ($list["content"]); ?></textarea><span class="must_red">*</span>
									</td>
								</tr>
								<input type="hidden" id="vid" name="vid" value="<?php echo ($list["id"]); ?>">
								<tr>
									<td>是否启用:</td>
									<td><select name="stat" id="stat">
											<?php if(is_array($stat)): foreach($stat as $key=>$vo): $selected=$list['stat']==$key?"selected":"" ?>
		...
		$().ready(function(){
			$(".btn_submit").click(function(){
				...
				if(avatar != '/statics/images/icon/upload-pic.png' && author != '' && content != ''){
					$.ajax({
						url:'/index.php?g=Vehicle&m=Index&a=veEdit',
						type:'post',
						data:{"author":author, "avatar":avatar,"content":content, "info_id":info_id,"vid":vid,'stat':stat},
