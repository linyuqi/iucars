			...
			<table class="table table-hover table-bordered table-list">
				<thead>
					<tr align=center>
						...
						<th width="15">序号</th>
						<th width="50">说明书ID</th>
						<th width="50">评论者</th>
						<th width="80">震后感内容</th>
						<th width="80">更新时间</th>
						<th width="50">状态</th>
						<th width="60">操作</th>
					</tr>
				...
				<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
					...
					<td><?php echo ($vo["edtime"]); ?></td>
					<td><?php echo ($vo["stat"]); ?></td>
					<td align=center>
						<a href="<?php echo U('Index/veEdit',array('id'=>$vo['id']));?>">编辑</a> | 
						<a href="<?php echo U('Index/veDelete',array('id'=>$vo['id']));?>" class="J_ajax_del">删除</a></td>
				</tr><?php endforeach; endif; ?>
				
			</table>
			<div class="table-actions">
				
				<button class="btn btn-primary btn-small J_ajax_submit_btn" type="submit" data-action="<?php echo U('Index/veDelete');?>" data-subcheck="true" data-msg="你确定删除吗？">删除</button>
