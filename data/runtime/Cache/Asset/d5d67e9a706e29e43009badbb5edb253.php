...
var swfu = '';
	$(document).ready(function(){
		Wind.use("swfupload",GV.DIMAUB+"statics/js/swfupload/handlers.js",function(){
			...
			file_upload_limit:"<?php echo ($limit_nums); ?>",
    ...
    <div class="pop_cont">
      <div class="">
        <div class="edit_uping"> 
            ...
            <span class="num">最多上传<em> <?php echo ($limit_nums); ?></em> 个附件,单文件最大 <em>20240 KB</em>，<em style="cursor: help;" title="可上传格式：jpg,jpeg,gif,png,bmp">支持格式？</em></span>
        </div>
...
<div id="att-args" style="display:none"><?php echo ($argsstr); ?></div>
